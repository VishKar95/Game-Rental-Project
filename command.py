...
while(1):
    ...
    if in1==1:
        ...
        try:
            f=open('D:\\vaishali\\python\\assignments\\Game Rental Project\\Sellers.json','r')
            content=json.load(f)
        ...
        if "@admin.com" not in Email_ID or (len(Email_ID)*len(Username)*len(Password)*len(Contact_Number))==0 or len(str(Contact_Number))!=10 or len(Password)<=4:
            ...
            operations.Register('seller','D:\\vaishali\\python\\assignments\\Game Rental Project\\Gamers.json','D:\\vaishali\\python\\assignments\\Game Rental Project\\Sellers.json',Email_ID,Username,Password,Contact_Number)
        ...
        if ".com" not in Email_ID or (len(Email_ID)*len(Username)*len(Password)*len(Contact_Number))==0 or len(Contact_Number)!=10 or len(Password)<=4:
            ...
            operations.Register('gamer','D:\\vaishali\\python\\assignments\\Game Rental Project\\Gamers.json','D:\\vaishali\\python\\assignments\\Game Rental Project\\Sellers.json',Email_ID,Username,Password,Contact_Number)
        ...
        print("Enter Password")
        Password=input()
        ch=operations.Login('seller','D:\\vaishali\\python\\assignments\\Game Rental Project\\Gamers.json','D:\\vaishali\\python\\assignments\\Game Rental Project\\Sellers.json',Username,Password)
        if ch==True:
            f=open('D:\\vaishali\\python\\assignments\\Game Rental Project\\Sellers.json','r')
            content=json.load(f)
            user_details=[]
            ...
            while(1):
                ...
                if in2==1:
                    ...
                    if len(Product_Name)*len(Product_type)==0 or Price_per_day<=0 or total_stock<=0:
                        print("Please enter valid data !!")
                        continue
                    operations.Create_Product(Username,'D:\\vaishali\\python\\assignments\\Game Rental Project\\Products.json',Product_id,Product_Name,Product_type,Price_per_day,total_stock)
                    ...
                    ch=operations.Update_Product(Username,'D:\\vaishali\\python\\assignments\\Game Rental Project\\Products.json',Product_id,Detail_to_be_updated,Updated_detail)
                    if ch==True:
                        print("Product updated successfully !!")
                    else:
                        print("Product not updated !!")
                elif in2==3:
                    details=operations.Fetch_all_Products_created_by_seller(Username,'D:\\vaishali\\python\\assignments\\Game Rental Project\\Products.json')
                    if len(details)==0:
                    ...
                    print("Enter Product ID")
                    Product_Id=input()
                    details=operations.Fetch_Product_By_ID('D:\\vaishali\\python\\assignments\\Game Rental Project\\Products.json',Product_Id)
                    if len(details)==0:
                        print("Invalid ID")
                    else:
                         for i in range(len(details)):
                    ...
                    print("Enter Username")
                    usrnm=input()
                    details=operations.View_User_Details('D:\\vaishali\\python\\assignments\\Game Rental Project\\Gamers.json',usrnm)
                    if len(details)==0:
        ...
        print("Enter Password")
        Password=input()
        ch=operations.Login('gamer','D:\\vaishali\\python\\assignments\\Game Rental Project\\Gamers.json','D:\\vaishali\\python\\assignments\\Game Rental Project\\Sellers.json',Username,Password)
        if ch==True:
            print("Welcome "+str(Username))
            in3=1
            while(in3!=7):
                ...
                in3=int(input())
                if in3==1:
                    l=operations.Fetch_all_products('D:\\vaishali\\python\\assignments\\Game Rental Project\\Products.json')
                    if len(l)==0:
                        print("No Products created !!")
                    else:
                    ...
                    if in31==1:
                        print("Enter Product ID")
                        Product_Id=input()
                        f=open('D:\\vaishali\\python\\assignments\\Game Rental Project\\Products.json','r')
                        try:
                            content=json.load(f)
                        except JSONDecodeError:
                            print("No products created !!")
                        ...
                        if Product_Id not in str(content):
                            ...
                            ch=operations.Add_item_to_wishlist(Username,Product_Id,'D:\\vaishali\\python\\assignments\\Game Rental Project\\Gamers.json')
                            if ch==True:
                    ...
                    if in31==1:
                        ...
                        if Product_Id not in str(content):
                            print("Please Enter Valid Product ID")
                            continue
                        can_add=operations.Add_item_to_cart(Username,Product_Id,Quantity,'D:\\vaishali\\python\\assignments\\Game Rental Project\\Gamers.json',Booking_start_date,Booking_end_date,'Products.json')
                        f.close()
                        if can_add==True:
                            print("Added item successfully !!")
                            continue
                    ...
                    if in31==2:
                        ...
                        if Product_Id not in str(content):
                            print("Please Enter Valid Product ID")
                            continue
                        can_remove=operations.Remove_item_from_cart(Username,Product_Id,'D:\\vaishali\\python\\assignments\\Game Rental Project\\Gamers.json')
                        if can_remove==True:
                            print("Item removed successfully from cart !!")
                        else:
                            print("Cannot remove item")
                    elif in31==3:
                        cart=operations.View_Cart(Username,'D:\\vaishali\\python\\assignments\\Game Rental Project\\Gamers.json')
                        if len(cart)==0:
                            print("Cart Empty !!")
                        else:
                    ...
                    order_placed=operations.Place_order(Username,'D:\\vaishali\\python\\assignments\\Game Rental Project\\Gamers.json',Order_id,'D:\\vaishali\\python\\assignments\\Game Rental Project\\Orders.json','D:\\vaishali\\python\\assignments\\Game Rental Project\\Products.json')
                    ...
                    print("Enter Updated detail")
                    Updated_detail=input()
                    upd=operations.Update_User('D:\\vaishali\\python\\assignments\\Game Rental Project\\Gamers.json',Username,Detail_to_be_updated,Updated_detail)
                    if upd==True:
                        print("Profile Updated successfully !!")
                    else:
                        print("Cannot Update Profile !!")
                elif in3==6:
                    orders=operations.Fetch_all_orders('D:\\vaishali\\python\\assignments\\Game Rental Project\\Orders.json',Username)
                    if len(orders)==0:
